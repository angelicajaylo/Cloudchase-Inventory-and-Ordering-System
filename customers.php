...
<head>
  ...
  if(isset($_POST["addsubmit"]))
  {
    ...
    $sqladdh = "INSERT INTO `hardwares_tbl` (`product_id`, `hardware_name`, `hardware_type`, `description`, `price`, `quantity`) VALUES (NULL, '$hname', '$htype', '$hdesc', '$hprice', '$hquantity');";
  ...
  { 
    ...
    $sqlupdateh = "UPDATE `hardwares_tbl` SET `hardware_name` = '$hname', `hardware_type` = '$htype', `description` = '$hdesc', `price` = '$hprice', `quantity` = '$hquantity' WHERE `hardwares_tbl`.`product_id` = $hid;";
  ...
  { 
    $hid=$_POST["hid"];
    $sqldelh = "DELETE FROM `hardwares_tbl` WHERE `hardwares_tbl`.`product_id` = $hid";
  ...
  $sqlmodal = "SELECT * FROM `user_account` where role = 'Customer'";
    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header ">
                ...
                <span class="float-sm-right"><button type="button" class="btn btn-success btn-block" data-toggle='modal' data-target='#modal-add'><i class="fa fa-user-plus"></i> Add New Customers</button></span>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
                ...
                {
                    $updatemod = '#update-'.$row['user_id'];
                    $deletemod = '#delete-'.$row['user_id'];
        ...
        <div class='modal-content'>
          ...
          <form method='post'>
            <div class='row'>
              ...
              <input type='text' class='form-control col-8  mb-2' hidden name='hid' value='$row[user_id]'>
            </div>
          </div>
          <div class='modal-footer justify-content-between'>
            <button type='button' class='btn btn-default' data-dismiss='modal'>Close</button> 
    ...
    <div class='modal fade' id='$deletemod'>
      <div class='modal-dialog'>
        <div class='modal-content'>
          ...
          <div class='modal-body'>
          <input type='text' class='form-control col-8  mb-2' hidden name='hid' value='$row[user_id]'>
            <p>Are you sure you want to DELETE this Hardware <span class='text-danger'>$row[firstname]</span>?</p>
          </div>
          <div class='modal-footer justify-content-between'>
            <button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>
